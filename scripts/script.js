...
function setupEqualizer() {
    ...
    // Connect Howler's master gain to the analyser and then to the destination
    ...
    if (counter == dataLength) {
        console.log("AH");
        setTimeout(setupEqualizer, 2000);
    }
}
...
function animateEqualizer() {
    ...
    // Get updated frequency data from the analyser
    analyser.getByteFrequencyData(dataArray);
...
const loadSongs = async () => {
    let response = await fetch('../scripts/songs.json');
